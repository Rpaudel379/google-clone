    ...
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <header className="flex w-full p-5 justify-between text-sm text-gray-700">
        <div className="flex space-x-4 items-center ">
          <p className="link  hover:underline">About</p>
          <p className="link  hover:underline">Store</p>
        </div>
        <div className="flex space-x-4 items-center">
          <p className="link  hover:underline">Gmail</p>
          <p className="link hover:underline">Images</p>
          ...
          <Avatar url="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" />
        </div>
      </header>
